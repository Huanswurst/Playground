# Generated by Django 5.1.5 on 2025-02-20 02:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["course", "role"], name="api_coursep_course__7420a7_idx"
                    )
                ],
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="api_attenda_student_0ea2b6_idx",
                    ),
                    models.Index(
                        fields=["event", "status"],
                        name="api_attenda_event_i_9527ac_idx",
                    ),
                ],
            },
        ),
